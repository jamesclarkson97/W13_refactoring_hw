let assert,Library,Book;_a19‍.w("assert",[["default",["assert"],function(v){assert=v}]]);_a19‍.w("../library",[["default",["Library"],function(v){Library=v}]]);_a19‍.w("../book",[["default",["Book"],function(v){Book=v}]]);// const assert = require('assert');
